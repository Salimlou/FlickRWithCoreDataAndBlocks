...
typedef enum {
    FlickDataToGetPlaces,
    FlickDataToGetPhotosAtPlace,
    FlickDataToGetPhotoByDictionnary,
    FlickDataToGetPhotoByUrl
}FlickDataToGet;
...
+ (id)getData:(FlickDataToGet)flickData withCriteria:(NSString *) criteria withBlock:(void (^)(id topPlacesArray))topPlacesBlock;
